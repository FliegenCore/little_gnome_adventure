...
namespace Game.CustomEditorWindws
{
    public class DialogueGraphView : GraphView
    {
        ...
        public DialogueWindow parentWindow;
        ...
        private void AddToolbar()
        {
            ...
            Button saveButton = new Button(() => SaveWithDialog())
            {
                text = "Save Graph"
            };

            Button loadButton = new Button(() => LoadWithDialog())
            {
                text = "Load Graph"
            };
        ...
        private void AddStyles()
        {
            ...
            if (styleGraphSheet != null) styleSheets.Add(styleGraphSheet);
            if (styleNodeSheet != null) styleSheets.Add(styleNodeSheet);
        }
